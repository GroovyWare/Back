...
public class CalendarService {
    ...
    public CalendarService(CalendarRepository calendarRepository, MemberRepository memberRepository, DepartmentRepository deptrepository, ModelMapper modelMapper)
    {
