...
public class ApprovalController {
	...
	/* 기안서 작성 */
	@PostMapping("/save")
	public ResponseEntity<ResponseDto> saveVacationHtml(@RequestBody ApprovalDto approvalDto, @AuthenticationPrincipal EmployeeDto employeeDto, @RequestParam String docTitle){
		
		DocumentDto documentDto = approvalService.selectDocumentCode(docTitle);
		
		approvalDto.setEmployee(employeeDto);
		approvalDto.setDocument(documentDto);
